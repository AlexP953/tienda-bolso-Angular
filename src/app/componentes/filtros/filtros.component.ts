...
export class FiltrosComponent implements OnInit {
  ...
  mensaje_enlace:String= 'Mostrar filtros';

  colores = [ 'todos', 'rojo', 'azul', 'negro', 'marron', 'bordo', 'blanco', 'verde' ];
  tipos = ['todos', 'billetera', 'bolso', 'neceser', 'mochila' ];
  ...
  mostrarOcultar(){
    ...
    if(this.mostrar){
      this.mostrar = false;
      this.mensaje_enlace = 'Mostrar filtros';
    } else {
      this.mostrar=true;
      this.mensaje_enlace='Ocultar filtros';
    }
  }
